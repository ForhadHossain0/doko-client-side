...
const handleProductAvailability = () =>{
  Swal.fire({
    ...
    return (
        ...
        <>  
        <h1 className='text-4xl font-semibold mt-16'>Our Most standard products Brands  here</h1>
       ...
       <div className='grid grid-cols-2 md:grid-cols-3   my-16'>
             ...
             <div className='  md:w-[250px] h-[200px] transition duration-300 ease-in-out hover:scale-110 hover:shadow-[0_20px_50px_rgba(8,_112,_184,_0.7)] shadow-[0px_10px_1px_rgba(221,_221,_221,_1),_0_10px_20px_rgba(204,_204,_204,_1)] m-3 '>
