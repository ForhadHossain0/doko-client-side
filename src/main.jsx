    ...
    children: [
      {
        path: "/",
        element: <Home></Home>,
        loader: () => fetch(`https://backend-server-q0zcknmh5-forhads-projects.vercel.app/products`),
      },
      {
        path: "/mycart",
      ...
      },
      {
        ...
        loader: ({ params }) => fetch(`https://backend-server-q0zcknmh5-forhads-projects.vercel.app/products/${params._id}`),
      },
      {
        path: "/brand1",
